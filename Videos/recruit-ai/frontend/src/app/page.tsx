...
export default function Home() {
  ...
  // Removed mouse position tracking to reduce rendering overhead
  ...
  // Removed mousemove event listener to improve performance
  // useEffect(() => {
  ...
  // Removed spring for scroll progress to reduce computation
    ...
    >
      ...
      <div className="flex flex-col">
        ...
        <section className="relative min-h-[75vh] flex flex-col items-center justify-center px-6 text-center overflow-hidden pt-20">
          ...
          {/* Removed Interactive Background Glow to reduce rendering overhead */}
          
          {/* Removed Abstract Floating Technical Elements to reduce rendering overhead */}

          {/* Removed Floating Candidate Snippets to reduce rendering overhead */}
        ...
        {/* Simplified Scroll Marquee - Removed animation */}
        ...
        {/* Removed animated background element to reduce rendering overhead */}
